...
export default function DashboardClient() {
  ...
  return (
    <div className="space-y-8">
      ...
      {isSetup && (
        <div className="gt-panel flex items-start gap-3 rounded-xl border border-orange-200 border-l-4 border-l-orange-500 bg-white p-4 text-slate-900 shadow-sm sm:items-center sm:gap-4 sm:p-5">
          <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-orange-50 text-orange-700">
      ...
      {!isSetup && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/dashboard/organizer" className="gt-panel gt-card-lift group flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:gap-4 sm:p-5">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-orange-50 text-orange-700">
              <Briefcase className="w-7 h-7" />
            </div>
            <div className="flex-1 min-w-0">
              <h3 className="text-base font-bold text-slate-900 sm:text-lg">Organizer Dashboard</h3>
              <p className="text-sm text-slate-500">Manage trips you&apos;ve created</p>
            </div>
            <ChevronRight className="hidden h-5 w-5 text-slate-300 transition-all group-hover:translate-x-1 group-hover:text-orange-400 sm:block" />
          </Link>

          <Link href="/dashboard/user" className="gt-panel gt-card-lift group flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:gap-4 sm:p-5">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-slate-700">
              <User className="w-7 h-7" />
            </div>
            <div className="flex-1 min-w-0">
              <h3 className="text-base font-bold text-slate-900 sm:text-lg">Bookings and Application</h3>
      ...
      <div className="gt-panel overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        {/* Header gradient */}
        <div className="h-24 border-b border-slate-800 bg-slate-900" />

        <div className="px-4 pb-6 sm:px-6 sm:pb-8">
          {/* Avatar row */}
          <div className="-mt-14 mb-6 flex flex-col items-start gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="relative">
              <div className="flex h-24 w-24 items-center justify-center overflow-hidden rounded-xl border-4 border-white bg-orange-600 text-3xl font-bold text-white shadow-md">
            ...
            <div className="flex w-full flex-wrap justify-end gap-2 sm:mt-14 sm:w-auto">
              {editing ? (
                <>
                  {!isSetup && (
                    <button
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-lg bg-orange-600 px-5 py-2.5 text-sm font-bold text-white transition hover:bg-orange-700 disabled:opacity-60"
                  >
                    {saving ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="md:col-span-2">
              <label htmlFor="profile-full-name" className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">
                Full Name *
              </label>
              {editing ? (
                <input
            ...
            {/* Email (read-only) */}
            <div>
              <label htmlFor="profile-phone" className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">
                Email
              </label>
            ...
            {/* Age */}
            <div>
              <label htmlFor="profile-age" className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">
                Age *
              </label>
              {editing ? (
                <input
            ...
            {/* Gender */}
            <div>
              <label htmlFor="profile-gender" className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">
                Gender *
              </label>
              {editing ? (
                <select
            ...
            {/* Profession */}
            <div>
              <label htmlFor="profile-bio" className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">
                Profession *
              </label>
              {editing ? (
            ...
            {(profile?.role === 'business' || profile?.role === 'super_admin') && (
              <div className="md:col-span-2">
                <label htmlFor="razorpay-account-id" className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">

        ...
        <main className="pt-28 pb-24 px-6 md:px-12 max-w-7xl mx-auto relative z-10">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-2xl bg-slate-100/10 border border-slate-400/30 flex items-center justify-center text-slate-300">
                    <Lock className="w-6 h-6" />
                  </div>
                  <span className="text-xs font-bold text-slate-300 uppercase tracking-widest">Your information</span>
                </div>
                <h1 className="gt-page-title text-4xl md:text-5xl font-bold tracking-tight">Privacy Policy</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white border border-slate-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="w-10 h-10 rounded-xl bg-slate-100/10 flex items-center justify-center text-slate-700 mb-4">
                ...
                <nav className="space-y-1">
                  {sections.map((sec) => (
                    <a
                      key={sec.id}
                      href={`#${sec.id}`}
                      className="group flex items-center justify-between px-3 py-2 rounded-xl text-sm font-medium text-slate-600 hover:text-slate-700 hover:bg-blue-50/50 transition-all"
                    >
